 ...
 */
int composite_plug_bridge(struct composite_plugin*container, aroop_txt_t*target, int (*bridge)(int signature, void*x), int(*desc)(aroop_txt_t*output));
/**
 ...
 * @param the composite
 */
int composite_plug_inner_composite(struct composite_plugin*container, aroop_txt_t*target, struct composite_plugin*x, int(*desc)(aroop_txt_t*output));
/**
